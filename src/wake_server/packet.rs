//! Thin helpers wrapping `crate::baichuan::bcudp` framing for the wake server.

use crate::baichuan::bcudp::{
...
mod tests {
	use super::*;
	use crate::baichuan::bcudp::xml::{C2mQ, IpPort, M2cQr};
	...
	fn decode_rejects_ack_packet_with_kind_label() {
		use crate::baichuan::bcudp::model::{BcUdp, UdpAck};
	...
	fn decode_rejects_data_packet_with_kind_label() {
		use crate::baichuan::bcudp::model::{BcUdp, UdpData};
