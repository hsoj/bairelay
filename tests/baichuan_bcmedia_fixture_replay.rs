...
use bairelay::baichuan::bcmedia::model::*;
...
fn replay_info_v1_yields_one_info_frame() {
	...
	let sample = include_bytes!("../src/baichuan/bcmedia/samples/info_v1.raw").to_vec();
...
fn replay_iframe_capture_yields_one_h264_iframe() {
	let sample = [
		include_bytes!("../src/baichuan/bcmedia/samples/iframe_0.raw").as_ref(),
		include_bytes!("../src/baichuan/bcmedia/samples/iframe_1.raw").as_ref(),
		include_bytes!("../src/baichuan/bcmedia/samples/iframe_2.raw").as_ref(),
		include_bytes!("../src/baichuan/bcmedia/samples/iframe_3.raw").as_ref(),
		include_bytes!("../src/baichuan/bcmedia/samples/iframe_4.raw").as_ref(),
	]
	.concat();
...
fn replay_pframe_capture_yields_one_h264_pframe() {
	let sample = [
		include_bytes!("../src/baichuan/bcmedia/samples/pframe_0.raw").as_ref(),
		include_bytes!("../src/baichuan/bcmedia/samples/pframe_1.raw").as_ref(),
	]
	.concat();
...
fn replay_argus2_iframe_extended_yields_one_iframe() {
	let sample = [
		include_bytes!("../src/baichuan/bcmedia/samples/argus2_iframe_0.raw").as_ref(),
		include_bytes!("../src/baichuan/bcmedia/samples/argus2_iframe_1.raw").as_ref(),
		include_bytes!("../src/baichuan/bcmedia/samples/argus2_iframe_2.raw").as_ref(),
		include_bytes!("../src/baichuan/bcmedia/samples/argus2_iframe_3.raw").as_ref(),
		include_bytes!("../src/baichuan/bcmedia/samples/argus2_iframe_4.raw").as_ref(),
	]
	.concat();
...
fn replay_argus2_pframe_extended_yields_multiple_frames() {
	let sample = [
		include_bytes!("../src/baichuan/bcmedia/samples/argus2_pframe_0.raw").as_ref(),
		include_bytes!("../src/baichuan/bcmedia/samples/argus2_pframe_1.raw").as_ref(),
		include_bytes!("../src/baichuan/bcmedia/samples/argus2_pframe_2.raw").as_ref(),
		include_bytes!("../src/baichuan/bcmedia/samples/argus2_pframe_3.raw").as_ref(),
		include_bytes!("../src/baichuan/bcmedia/samples/argus2_pframe_4.raw").as_ref(),
		include_bytes!("../src/baichuan/bcmedia/samples/argus2_pframe_5.raw").as_ref(),
		include_bytes!("../src/baichuan/bcmedia/samples/argus2_pframe_6.raw").as_ref(),
		include_bytes!("../src/baichuan/bcmedia/samples/argus2_pframe_7.raw").as_ref(),
		include_bytes!("../src/baichuan/bcmedia/samples/argus2_pframe_8.raw").as_ref(),
		include_bytes!("../src/baichuan/bcmedia/samples/argus2_pframe_9.raw").as_ref(),
		include_bytes!("../src/baichuan/bcmedia/samples/argus2_pframe_10.raw").as_ref(),
		include_bytes!("../src/baichuan/bcmedia/samples/argus2_pframe_11.raw").as_ref(),
		include_bytes!("../src/baichuan/bcmedia/samples/argus2_pframe_12.raw").as_ref(),
		include_bytes!("../src/baichuan/bcmedia/samples/argus2_pframe_13.raw").as_ref(),
		include_bytes!("../src/baichuan/bcmedia/samples/argus2_pframe_14.raw").as_ref(),
		include_bytes!("../src/baichuan/bcmedia/samples/argus2_pframe_15.raw").as_ref(),
		include_bytes!("../src/baichuan/bcmedia/samples/argus2_pframe_16.raw").as_ref(),
		include_bytes!("../src/baichuan/bcmedia/samples/argus2_pframe_17.raw").as_ref(),
	]
	.concat();
...
fn replay_swan_capture_mixes_video_and_adpcm() {
	let sample = [
		include_bytes!("../src/baichuan/bcmedia/samples/video_stream_swan_00.raw").as_ref(),
		include_bytes!("../src/baichuan/bcmedia/samples/video_stream_swan_01.raw").as_ref(),
		include_bytes!("../src/baichuan/bcmedia/samples/video_stream_swan_02.raw").as_ref(),
		include_bytes!("../src/baichuan/bcmedia/samples/video_stream_swan_03.raw").as_ref(),
		include_bytes!("../src/baichuan/bcmedia/samples/video_stream_swan_04.raw").as_ref(),
		include_bytes!("../src/baichuan/bcmedia/samples/video_stream_swan_05.raw").as_ref(),
		include_bytes!("../src/baichuan/bcmedia/samples/video_stream_swan_06.raw").as_ref(),
		include_bytes!("../src/baichuan/bcmedia/samples/video_stream_swan_07.raw").as_ref(),
		include_bytes!("../src/baichuan/bcmedia/samples/video_stream_swan_08.raw").as_ref(),
		include_bytes!("../src/baichuan/bcmedia/samples/video_stream_swan_09.raw").as_ref(),
	]
	.concat();
...
fn replay_adpcm_frames_report_expected_block_size() {
	let sample = include_bytes!("../src/baichuan/bcmedia/samples/adpcm_0.raw").to_vec();
